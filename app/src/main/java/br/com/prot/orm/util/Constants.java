package br.com.prot.orm.util;

/**
 * Created by fredericom on 09/03/2018.
 */
...
public class Constants {
    ...
    public static final String HINT_INPUT_NOME = "Informe o nome.";
    public static final String HINT_INPUT_IDADE = "informe a idade.";
    public static final String HINT_INPUT_EMAIL = "informe o e-mail.";
